...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a _ngcontent-c0="" routerlinkactive="active" title="Travelo - home" ng-reflect-router-link="/home" ng-reflect-router-link-active="active" href="/home" class="active"> <img _ngcontent-c0="" alt="Travelo HTML5 Template" src="assets/images/logo.png"></a></h1>').insertBefore('.chaser .menu');
...
// adlist tiles active change
tjq("body").on("click", ".swap-tiles li", function(e) {
    e.preventDefault();
    tjq('.swap-tiles li.active').removeClass('active');
...
define(["require", "exports"], function(require, exports){
	   ...
	   exports.showError = function(){
			// Get the snackbar DIV
			    var x = document.getElementById("alert");//.getElementsByTagName('a')[0];

			    // Add the "show" class to DIV
			    x.className = "alerte";
			    close = document.getElementById("close");
			    close.addEventListener('click', function() {
			      note = document.getElementById("alert");
			      note.className = "";
